...
use OpenClassrooms\OpenAPIValidation\PSR7\Exception\Validation\InvalidSecurity;
...
final class SecurityHTTPTest extends TestCase
{
    ...
    {
        $request = new ServerRequest('get', '/products')->withHeader(
            'Authorization',
            'Bearer ABCDEFG',
        );

        $validator = new ValidatorBuilder()
            ->fromYaml($this->specBearer)
    ...
    public function testItChecksBearerHeaderRed(): void
    {
        ...
        $this->expectExceptionMessage(
            'None of security schemas did match for Request [get /products]',
        );
